...
export const meBackgroundImage: ImageSourcePropType = require('@/assets/images/me-bg.png');
export const avatarFallbackImage: ImageSourcePropType = require('@/assets/images/avatar.png');
export const emptyImage: ImageSourcePropType = require('@/assets/images/empty.png');
export const apexLogoImage: ImageSourcePropType = require('@/assets/images/apex.png');
